...
import { IDatasetInfoApiVerifierServerModule } from './IDatasetInfoApi.module';

export async function runIDatasetInfoApiVerifierServer() {
  const moduleClass = IDatasetInfoApiVerifierServerModule;
